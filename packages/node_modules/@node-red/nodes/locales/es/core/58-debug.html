...
<script type="text/x-red" data-help-name="debug">
    <p>Muestra las propiedades de mensaje seleccionadas en la pesta&ntilde;a barra lateral de depuracion y, opcionalmente, el registro de tiempo de ejecucion. De forma predeterminada, muestra <code> msg.payload </code>, pero puede configurarse para mostrar cualquier propiedad, el mensaje completo o el resultado de una expresión JSONata. </p>
    <h3>Details</h3>
